...
__all__ = ['SimpleMLP', 'SimpleConv', 'UNet', 'ResConvBlock', 'CNN', 'CNN2']
...
class SimpleMLP(nn.Module):
    ...
    def __init__(self, in_channels=8):
        ...
        init_sequential_weights(self.transform_net)

    def forward(self, x):
        """Forward pass through the structure.
